...
public class Objeto {
    ...
    public Objeto( int modoDes, int numCompPos, int numCompCor, int numCompTex,
        ...
        /*carregaRecursos( modoDes, numCompPos, numCompCor, numCompTex,
                vertices, elementos,
                textura, texPb );*/
    ...
    /*private void carregaRecursos( int modoDes, int numCompPos, int numCompCor, int numCompTex,
                                  @NonNull float[] vertices, @NonNull int[] elementos,
                                  int textura, boolean texPb ) {
        this.modoDes = modoDes;
        this.textura = textura;
    ...
    private static int[] getElementos( int numCompPos, int numCompCor, int numCompTex, @NonNull float[] vertices ) {
    ...
    public Objeto( int modoDes, int numCompPos, int numCompCor,
                   @NonNull float[] vertices, @NonNull int[] elementos ) {
        /*carregaRecursos( modoDes, numCompPos, numCompCor, 0,
                         vertices, elementos,
                  0, false );*/
    ...
    public Objeto( int modoDes, int numCompPos, int numCompTex,
                   @NonNull float[] vertices, @NonNull int[] elementos,
                   int textura, boolean texPb ) {
        /*carregaRecursos( modoDes, numCompPos, 0, numCompTex,
                         vertices, elementos,
                         textura, texPb );*/
